 ...
 */
package org.emsg.smart_connector.netty.utils;

import org.emsg.smart_connector.commons.constants.ServerConstants;
...
public class NettyUtils {
    ...
    private static final AttributeKey<Object> ATTR_KEY_KEEPALIVE = AttributeKey.valueOf(ServerConstants.KEEP_ALIVE);
    private static final AttributeKey<Object> ATTR_KEY_CLEANSESSION = AttributeKey.valueOf(ServerConstants.CLEAN_SESSION);
    private static final AttributeKey<Object> ATTR_KEY_CLIENTID = AttributeKey.valueOf(ServerConstants.ATTR_CLIENTID);
